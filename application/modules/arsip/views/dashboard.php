                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            <div class="row">
                                ...
                                <?php if ($this->session->userdata("id_user") == "14") : ?>
                                    <div class="col-lg-4 col-12">
                                        <div class="small-box bg-olive">
                                            <div class="inner">
                                                <h3 class="jml_pinjam"></h3>
                                                <p>Peminjaman Arsip</p>
                                            </div>
                                            <div class="icon">
                                                <i class="ion ion-bag"></i>
                                            </div>
                                            <a href="<?php echo site_url('../pinjam'); ?>" class="small-box-footer">Lihat Semua <i class="fas fa-arrow-circle-right"></i></a>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
