			...
			<div class="row">
				...
				<div class="col-10">
					<div class="card">
						...
						<div class="card-body">
							<!-- form start -->
							<form class="form-horizontal" method="post" action="<?php echo site_url('../nota_dinas/edit2/' . $nota_dinas->id_nota_dinas); ?>">
								<div class="card-body">
									<div class="form-group row">
										<label for="inputEmail3" class="col-sm-2 col-form-label">Tanggal</label>
										<div class="col-sm-10">
											<input type="date" class="form-control" name="tgl_nota_dinas" placeholder="Tanggal Nota Dinas" value="<?php echo date('Y-m-d', strtotime($nota_dinas->tgl_nota_dinas)); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<select name="kegiatan" class="form-control select2" style="width: 100%" data-placeholder="Pilih Kegiatan">
												...
												foreach ($dpa as $row) {
												?>
													<option <?php if ($row->id_dpa == $nota_dinas->id_dpa) {
																echo "selected";
															} ?> value="<?php echo $row->id_dpa; ?>"><?php echo $row->nama_dpa; ?></option>
												<?php
												}
												?>
											</select>
										...
										<div class="col-sm-4">
											<select name="bulan" class="form-control select2" style="width: 100%" data-placeholder="Pilih Kegiatan">
												...
												?>
													<option <?php if ($val == $nota_dinas->bulan) {
																echo "selected";
													...
													?>
														<tr id="trx-<?php echo $key->id_nota_detail; ?>">
															...
															<td align="center">
																...
																<input type="hidden" name="jumlah[]" value="<?php echo $key->nominal; ?>">
																<input type="hidden" name="rok[]" value="<?php echo $key->rok; ?>">
																<input type="hidden" name="alasan[]" value="<?php echo $key->alasan; ?>">
																<span class="text-danger" onclick="delRek('trx-<?php echo $key->id_nota_detail; ?>')" style="cursor: pointer"><i class="fa fa-times"></i></span>
															</td>
														</tr>
													<?php
													}
