						...
						<div class="row">
							...
							<div class="col-10">
								<div class="card">
									...
									<div class="card-body">
										<!-- form start -->
										<form class="form-horizontal" method="post" action="<?php echo site_url('../services/postNota/'.$nota_dinas->id_nota_dinas); ?>">
											<div class="card-body">
											...
											<div class="card-footer">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <button type="submit" class="btn btn-info btn-block" onclick="return confirm('Validasi?')"><i class="fa fa-check"></i> Validasi</button>
                                                    </div>
													<div class="col-sm-2">
