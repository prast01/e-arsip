    ...
    <td class="text-center">
        <div class="btn-group">
            ...
            <?php
                ...
                if(($row->validasi == '0' && $this->session->userdata('posisi') == $row->created_by) || ($this->session->userdata('posisi') == '6' && $this->session->userdata('level') == '1')){
            ?>
        ...
        <?php
            if($row->validasi == '0' && ($this->session->userdata('posisi') == '6' && $this->session->userdata('level') == '1')){
        ?>
		<br><br>
        <div class="btn-group">
