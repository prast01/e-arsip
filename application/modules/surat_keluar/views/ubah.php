                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="penerima" id="penerima" placeholder="Penerima" value="<?= $surat->penerima; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-4 col-form-label">Tanggal Naik</label>
                                            <div class="col-sm-8">
                                                <input type="date" class="form-control" name="tgl_naik" placeholder="Tanggal Naik" value="<?= $surat->tgl_naik; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h4>Pengiriman</h4>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-4 col-form-label">Tanggal TTD</label>
                                            <div class="col-sm-8">
                                                <input type="date" class="form-control" name="tgl_ttd" placeholder="Tanggal TTD" value="<?= $surat->tgl_ttd; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-4 col-form-label">Unit Kerja</label>
                                            <div class="col-sm-8">
                                                <select name="unit_kerja" class="form-control select2 dispo" style="width: 100%" data-placeholder="Pilih Unit Kerja">
                                                    <?php
                                                    foreach ($dispo as $row) {
                                                    ?>
                                                        <option <?= ($surat->unit_kerja == $row['id_posisi']) ? "selected" : ""; ?> value="<?php echo $row['id_posisi']; ?>"><?php echo $row['posisi']; ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
