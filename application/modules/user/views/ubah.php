						...
						<div class="row">
							...
							<div class="col-10">
								<div class="card">
									...
									<div class="card-body">
										<!-- form start -->
										<form class="form-horizontal" method="post" action="<?php echo site_url('../user/edit/'.$user->id_user); ?>">
											<div class="card-body">
												<div class="form-group row">
													<label for="inputEmail3" class="col-sm-2 col-form-label">Username</label>
													<div class="col-sm-10">
														<input type="text" name="user" class="form-control" placeholder="Username" value="<?php echo $user->username_user; ?>">
													</div>
												</div>
												<!-- <div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<select name="level_user" class="form-control select2" style="width: 100%">
															...
															?>
															<option <?php if($user->level_user == $row->id_level_user){ echo "selected"; } ?> value="<?php echo $row->id_level_user; ?>"><?php echo $row->user_level; ?></option>
															<?php
																}
															?>
														</select>
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<select name="posisi_user" class="form-control select2" style="width: 100%">
															...
															?>
															<option <?php if($user->posisi_user == $row->id_posisi){ echo "selected"; } ?> value="<?php echo $row->id_posisi; ?>"><?php echo $row->posisi; ?></option>
															<?php
																}
															?>
														</select>
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<select name="id_pegawai" class="form-control select2" style="width: 100%">
															...
															?>
															<option <?php if($user->id_pegawai == $row->id_pegawai){ echo "selected"; } ?> value="<?php echo $row->id_pegawai; ?>"><?php echo $row->nama_pegawai; ?></option>
															<?php
																}
															?>
														</select>
