						...
						<div class="row">
							...
							<div class="col-10">
								<div class="card">
									...
									<div class="card-body">
										<!-- form start -->
										<form class="form-horizontal" method="post" action="<?php echo site_url('../surat_tugas/printout2/'.$surat->id_surat_tugas); ?>" enctype="multipart/form-data">
											...
											<div class="card-body">
												...
												<div class="form-group row">
													<label for="inputEmail3" class="col-sm-2 col-form-label">Di SPJ-kan ?</label>
													<div class="col-sm-10 mt-2">
														<div class="custom-control custom-radio">
												...
												<div class="form-group row">
													...
													<div class="col-sm-5">
														<select name="dpa" required class="form-control select2" style="width: 100%" data-placeholder="Pilih DPA">
													...
													<div class="col-sm-5">
														<select name="rekening" required class="form-control select2" style="width: 100%" data-placeholder="Pilih rekening">
															<option selected disabled>Pilih</option>
											...
											<div class="card-footer">
                                                <div class="row">
													...
													<div class="col-md-2 col-xs-10">
														<a href="<?php echo site_url('../surat_tugas/preview3/'.$surat->id_surat_tugas); ?>" class="btn btn-primary btn-block" title="Cetak SPPD Belakang"><i class="fa fa-print"></i> Cetak SPPD Belakang</a>
													</div>
													<div class="col-md-2 col-xs-10">
