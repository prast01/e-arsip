...
<html lang="en">
	<head>
		...
		<style>
			@media print {
				body {margin-top: 0mm; margin-bottom: 5mm; 
	...
	<body onLoad="window.print()" onclick="pindah('<?php echo $surat->id_surat_tugas; ?>')">
		...
		<table border="0" width="100%">
			...
			<tr>
				<td></td><td>Pangkat/Gol.</td><td>:</td><td>Pembina Tk. I/IVb</td>
			</tr>
			<tr>
			...
			<tr>
				<td width="8%"></td><td width="10%">Nama</td>
				<td width="1%">:</td>
				<td width="81%">Drs. ADI BINTORO, MM</td>
			</tr>
			<tr>
				<td></td><td>NIP</td><td>:</td><td>19630326 199203 1 002</td>
			</tr>
			<tr>
				<td></td><td>Pangkat/Gol.</td><td>:</td><td>Pembina/IVa</td>
			</tr>
			<tr>
				<td></td><td>Jabatan</td><td>:</td><td>Plt. Sekretaris Dinas Kesehatan Kab. Jepara</td>
			</tr>
			<?php
				}
			?>
