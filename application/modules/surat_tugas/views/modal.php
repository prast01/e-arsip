										...
										<!-- form start -->
										<form class="form-horizontal" method="post" action="<?php echo site_url('../surat_tugas/upload/'.$surat->id_surat_tugas); ?>" enctype="multipart/form-data">
											<div class="card-body">
												<div class="form-group row">
													<label for="inputEmail3" class="col-sm-2 col-form-label">Dasar Surat</label>
													<div class="col-sm-10">
														<textarea name="perihal_surat" disabled class="form-control" rows="3"><?php echo $surat->dasar_surat; ?></textarea>
													</div>
												</div>
												<div class="form-group row">
