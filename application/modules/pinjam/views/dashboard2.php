                ...
                <div class="col-10">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-12">
                                    <a href="<?= site_url("../pinjam"); ?>" class="btn btn-warning text-white"><span class="fa fa-arrow-left"></span> Kembali</a>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <form action="<?php echo site_url('../pinjam/kembali'); ?>" method="post">
