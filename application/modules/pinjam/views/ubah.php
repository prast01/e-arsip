                ...
                <div class="col-10">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <form class="form-horizontal" method="post" action="<?php echo site_url('../pinjam/edit/' . $berkas->id_pinjam); ?>" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" id="referensi" name="referensi" value="<?= $berkas->referensi; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control" id="tgl_pinjam" required name="tgl_pinjam" value="<?= $berkas->tgl_pinjam; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" required id="nama_peminjam" name="nama_peminjam" value="<?= $berkas->nama_peminjam; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Keperluan</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="keperluan" name="keperluan" value="<?= $berkas->keperluan; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Catatan Peminjaman</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="catatan" name="catatan" value="<?= $berkas->catatan; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
