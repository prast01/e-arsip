                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-1">
                                    <a href="<?php echo site_url('../surat_masuk'); ?>" class="btn btn-warning btn-rounded text-white">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="<?php echo site_url('../surat_masuk/terdispo'); ?>" method="post">
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                                <select name="bulan" class="form-control select2" style="width: 100%">
                                                    ...
                                                    ?>
                                                        <option <?php if ($p_bln == $row) {
                                                                    echo "selected";
                                                                } ?> value="<?php echo $row; ?>"><?php echo $val; ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        ?>
                                            <tr class="">
                                                ...
                                                <td>
                                                    ...
                                                    echo 'Pengirim : ' . strtoupper($row->pengirim) . '<br>';
                                                    echo '- ' . $row->tgl_surat . '<br>';
                                                    echo '- ' . $row->jenis . '<br>';
                                                    echo '- ' . $row->nomor_surat . '<br>';
