							...
							<form class="form-horizontal" method="post" action="<?php echo site_url('../surat_masuk/d2/' . $surat->id_surat_masuk); ?>" enctype="multipart/form-data">
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<div class="custom-control custom-radio">
												<input class="custom-control-input" type="radio" id="customRadio4" name="arsip" value="0" <?= ($surat->arsipkan_3 == '0') ? "checked" : ""; ?> onclick="dispo(this)">
												<label for="customRadio4" class="custom-control-label">Teruskan Ke</label>
											</div>
											<br>
											<select name="dispo_surat_bidang[]" class="form-control select2 dispo" style="width: 100%" multiple data-placeholder="Pilih Dispo" <?= ($surat->arsipkan_3 != '0') ? "disabled" : ""; ?>>
												<!-- <option disabled>Pilih</option> -->
												<?php
										...
										<div class="col-sm-4">
											<div class="custom-control custom-radio">
												<input class="custom-control-input" type="radio" id="customRadio3" name="arsip" value="1" <?= ($surat->arsipkan_3 != '0') ? "checked" : ""; ?> onclick="dispo(this)">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<textarea name="catatan_bidang" class="form-control" rows="3"><?php echo $surat->catatan_kabid; ?></textarea>
