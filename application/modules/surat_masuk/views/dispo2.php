						...
						<div class="row">
							...
							<div class="col-10">
								<div class="card">
									...
									<div class="card-body">
										<!-- form start -->
										<form class="form-horizontal" method="post" action="<?php echo site_url('../surat_masuk/d2/'.$surat->id_surat_masuk); ?>" enctype="multipart/form-data">
											<div class="card-body">
												...
												<div class="form-group row">
													<label for="inputEmail3" class="col-sm-2 col-form-label">Disposisi</label>
													<div class="col-sm-10">
														<select name="dispo_surat_sekdin" disabled multiple class="form-control select2" style="width: 100%">
															<!-- <option disabled>Pilih</option> -->
															<?php
												...
												<div class="form-group row">
													...
													<div class="col-sm-6">
														<div class="custom-control custom-radio">
															<input class="custom-control-input" type="radio" id="customRadio4" name="arsip" value="0" <?php if($surat->arsipkan_3 == '0'){ echo "checked"; } ?> onclick="dispo(this)">
															<label for="customRadio4" class="custom-control-label">Teruskan Ke</label>
														</div>
														<br>
														<select name="dispo_surat_bidang[]" class="form-control select2 dispo" style="width: 100%" multiple data-placeholder="Pilih Dispo" <?php if($surat->arsipkan_3 != '0'){ echo "disabled"; } ?>>
															<!-- <option disabled>Pilih</option> -->
															<?php
													...
													<div class="col-sm-4">
														<div class="custom-control custom-radio">
															<input class="custom-control-input" type="radio" id="customRadio3" name="arsip" value="1" <?php if($surat->arsipkan_3 != '0'){ echo "checked"; } ?> onclick="dispo(this)">
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<textarea name="catatan_bidang" class="form-control" rows="3"><?php echo $surat->catatan_bidang; ?></textarea>
