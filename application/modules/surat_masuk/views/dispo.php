									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<div class="custom-control custom-radio">
												<input class="custom-control-input" type="radio" id="customRadio4" name="arsip" value="0" <?= ($surat->arsipkan_2 == '0') ? "checked" : ""; ?> onclick="dispo(this)">
												<label for="customRadio4" class="custom-control-label">Teruskan Ke</label>
											</div>
											<br>
											<select name="dispo_surat_sekdin[]" class="form-control select2 dispo" style="width: 100%" multiple data-placeholder="Pilih Dispo" <?= ($surat->arsipkan_2 != '0') ? "disabled" : ""; ?>>
												<?php
										...
										<div class="col-sm-4">
											<div class="custom-control custom-radio">
												<input class="custom-control-input" type="radio" id="customRadio3" name="arsip" value="1" <?= ($surat->arsipkan_2 != '0') ? "checked" : ""; ?> onclick="dispo(this)">
